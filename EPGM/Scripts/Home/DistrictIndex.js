...
jQuery(document).ready(function () {
    ...
    $(".subBut").click(function () {
        ...
        window.location.href = urlContent + "Project/Index/?dW5kZWZpbmVk=" + whoType + "&BeneType=" + $("#BeneType option:selected").val() + "&Month=" + $("#ddlMonth option:selected").val() + "&Year=" + $("#txtYear").val();
    });
...
function BindGrid() {
    ...
    grid.jqGrid({
        ...
        colNames: ['DistrictID', 'S.No', 'District Code', 'District Name', 'Project Code', 'Project Name', 'Total Beneficiaries', 'No.of Children Weighed', 'Attendance Count', 'Normal', 'Moderate', 'Severe', 'Normal', 'MAM', 'SAM', 'Normal', 'Moderate', 'Severe', 'Absent'],
        colModel: [
                ...
                { name: 'ProjectCode', index: 'ProjectCode', width: 160, hidden: true },
		  		{ name: 'ProjectName', index: 'ProjectName', width: 140, formatter: showDistricts, sortable: true },
...
function showDistricts(cellvalue, options, rowObject) {
    ...
    return "<a href='" + urlContent + "Home/Report/?distCode=" + rowObject.DistrictCode + "&projCode=" + rowObject.ProjectCode + "'style='text-decoration: underline;color:red'>" + rowObject.ProjectName + "</a>";
}
