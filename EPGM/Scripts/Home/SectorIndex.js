...
jQuery(document).ready(function () {
    ...
    $(".subBut").click(function () {
        ...
        window.location.href = urlContent + "AWC/Index/?dW5kZWZpbmVk=" + whoType + "&BeneType=" + $("#BeneType option:selected").val() + "&Month=" + $("#ddlMonth option:selected").val() + "&Year=" + $("#txtYear").val();
    });
...
function BindGrid() {
    ...
    grid.jqGrid({
        ...
        colNames: ['DistrictID', 'S.No', 'District Code', 'District Name', 'Project Code', 'Project Name', 'Sector Code', 'Sector Name', 'Center Code', 'Center Name', 'Total Beneficiaries', 'No.of Children Weighed', 'Attendance Count', 'Normal', 'Moderate', 'Severe', 'Normal', 'MAM', 'SAM', 'Normal', 'Moderate', 'Severe', 'Absent'],
        colModel: [
