...
jQuery(document).ready(function () {
    ...
    setInterval(GetDashStatCount, 90000);


    $(".subBut").click(function () {
        debugger;
        var whoType = btoa(this.id);
        window.location.href = urlContent + "District/Index/?dW5kZWZpbmVk=" + whoType + "&BeneType=" + $("#BeneType option:selected").val() + "&Month=" + $("#ddlMonth option:selected").val() + "&Year=" + $("#txtYear").val();
    });
...
function BindGrid() {
    ...
    grid.jqGrid({
        ...
        beforeRequest: function () {
            ...
            $.extend(postData, { "BeneType": $("#BeneType option:selected").val(), "Month": $("#ddlMonth option:selected").val(), "Year": $("#txtYear").val() });
        },
