...
function BindGrid() {
    ...
    jQuery('#Grid').jqGrid({
        ...
        colModel: [
                ...
                { name: 'DOB', index: 'DOB', width: 85, align: 'left' },
                ...
                { name: 'RegisteredDateTime', index: 'RegisteredDateTime', width: 90, align: 'left' },
                { name: 'ResidentType', index: 'ResidentType', width: 80, align: 'left' },
                { name: 'ActionId', index: 'ActionId', width: 80, formatter: actionFormatter },
                { name: 'IsRegisteredAtAttendance', index: 'IsRegisteredAtAttendance', width: 80, formatter: RegisterPerson, align: 'center' },
                { name: 'RegisteredAtAttendanceDate', index: 'RegisteredAtAttendanceDate', width: 80, align: 'center' },
                { name: 'IsEnrolledAtAttendance', index: 'IsEnrolledAtAttendance', formatter: EnrolledAttendance, width: 80, align: 'center' },
                { name: 'EnrolledAtAttendanceDate', index: 'EnrolledAtAttendanceDate', width: 80, align: 'center' },
                ...
                { name: 'DeletePersonFace', index: 'DeletePersonFace', width: 80, align: 'center', formatter: DeletePersonFace },
