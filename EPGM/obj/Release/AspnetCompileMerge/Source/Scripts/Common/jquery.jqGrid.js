...
//Helper functions
	...
	createModal : function(aIDs, content, p, insertSelector, posSelector, appendsel, css) {
		...
		mw.className= "ui-widget ui-widget-content ui-corner-all ui-jqdialog solidbg";
		mw.id = aIDs.themodal;
		...
		$(mc).addClass("ui-jqdialog-content ui-widget-content solidbg").attr("id", aIDs.modalcontent);
		$(mc).append(content);
		mw.appendChild(mc);
		$(mw).prepend(mh);
	...
	return this.each( function() {
		...
		*/
		...
		this.createTableForGroup = function(group, parentgroup) {
			...
			if (group.groups !== undefined) {
				for (i = 0; i < group.groups.length; i++) {
					var trHolderForSubgroup = $("<tr class='solidbg'></tr>");
		...
		this.createTableRowForRule = function(rule, group ) {
			...
			var that=this, $t = getGrid(), tr = $("<tr class='solidbg'></tr>"),
	...
	searchGrid : function (p) {
		...
		return this.each(function() {
			...
			if ( $("#"+$.jgrid.jqID(IDs.themodal))[0] !== undefined ) {
				...
				var fil = $("<div><div id='"+fid+"' class='searchFilter solidbg' style='overflow:auto'></div></div>").insertBefore("#gview_"+$.jgrid.jqID($t.p.id)),
				align = "left", butleft =""; 
